#!/bin/bash
# run_experiments.sh — best_model/400epochs
# Best config: ResNet34d + Channel Attention + Tuning(Excl+Added)
# AdamW, wd=5e-3, CutMix=0.5, rotation=15, crop_bbox, 400 epochs
# 실행: bash best_model/400epochs/run_experiments.sh  (프로젝트 루트에서)
...
LOGFILE="$LOG_DIR/best_model_400ep_${TIMESTAMP}.log"
