...
declare module '$env/static/private' {
	...
	export const EFC_14728_1592913036: string;
	...
	export const LAMMPSHOME: string;
	export const LAMMPS_PLUGIN_PATH: string;
	export const LAMMPS_POTENTIALS: string;
	export const LANG: string;
	export const LOCALAPPDATA: string;
	export const LOGONSERVER: string;
	export const MSI2LMP_LIBRARY: string;
	...
	export const PLUMED_ROOT: string;
...
declare module '$env/dynamic/private' {
	export const env: {
		...
		JAVA_HOME: string;
		LAMMPSHOME: string;
		LAMMPS_PLUGIN_PATH: string;
		LAMMPS_POTENTIALS: string;
		LANG: string;
		LOCALAPPDATA: string;
		LOGONSERVER: string;
		MSI2LMP_LIBRARY: string;
		NODE: string;
		NODE_ENV: string;
		NODE_EXE: string;
		NPM_CLI_JS: string;
